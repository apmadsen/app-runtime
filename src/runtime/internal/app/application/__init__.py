...
from sys import stdout, modules, platform
...
from milieu.internal.app.application.single_instance_exception import SingleInstanceException
from milieu.internal.app.locking import lock_handle
from milieu.internal.app.user import is_elevated
...
def get_installalled_apps_path(elevated: bool = IS_ELEVATED) -> str:
    ...
    if elevated:
        ...
        if platform == "win32":
            return path.join(path.abspath(getenv("LocalAppData")), "Programs")
        else:
            return "~/.local"
